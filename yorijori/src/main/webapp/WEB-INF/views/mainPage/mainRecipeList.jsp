...
<link rel="stylesheet" href="/erp/common/css/mainPage/mainRecipeList.css" />
</head>
<body>
	<div class="container-fluid">
		<div class="px-lg-5">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-4 col-md-6 mb-4">
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							<h5>
								<a href="#" class="text-dark">레시피 제목</a>
							</h5>
							<p class="small text-muted mb-0">유저 닉네임</p>
							<div
					...
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							...
							<div
								...
								<p class="small mb-0">
									<i class="fa fa-picture-o mr-2"></i><span
										class="font-weight-bold">PNG</span>
								</p>
								<div
									class="badge badge-primary px-3 rounded-pill font-weight-normal">Trend</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							...
							<div
								...
								<div
									class="badge badge-warning px-3 rounded-pill font-weight-normal text-white">Featured</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							...
							<div
								...
								<p class="small mb-0">
									<i class="fa fa-picture-o mr-2"></i><span
										class="font-weight-bold">JPEG</span>
								</p>
								<div
									class="badge badge-success px-3 rounded-pill font-weight-normal">Hot</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							...
							<div
								...
								<div
									class="badge badge-primary px-3 rounded-pill font-weight-normal">New</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white rounded shadow-sm">
						...
						<div class="p-4">
							...
							<div
								...
								<div
									class="badge badge-info px-3 rounded-pill font-weight-normal">Hot</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="py-5 text-right">
				<a href="#" class="btn btn-dark px-5 py-3 text-uppercase">추천 레시피 링크 걸기?</a>
			</div>
		</div>
	</div>
