...
public class FileUploadLogic {
	...
	public List<?> uploadFiles(List<MultipartFile> multipartFiles, String path)
...
// 파일 존재하면 삭제해주는 코드인데 이상있어서 테스트 후 사용할 것 ㅠ
//	public void deleteexistimage(String storefilename) {
//		System.out.println(storefilename);
//		String imagePath = uploadpath + "user/" + storefilename;
//		System.out.println("deleteexistimage 의  이미지패스 "+imagePath);
//	}
}
