...
public class MyPageController {
	...
	public String updateprofileimage(HttpSession session, MultipartFile profilephoto,
			String cookingpurpose) {
		UserInfo user = (UserInfo)session.getAttribute("userInfo");
		
		user.setPurpose(cookingpurpose);
		
		if(profilephoto != null) {
		String fileRoot = "C:\\project\\upload\\user\\";	//저장될 외부 파일 경로
