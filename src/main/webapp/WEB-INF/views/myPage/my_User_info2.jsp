...
<link rel="stylesheet"
	href="/erp/common/css/mainPage/my_User_info2.css" />
<script
			...
			<div class="col-md-3 border-right">
				<div
					...
					<img class="rounded-circle mt-5" width="150px"
						...
						<span class="text-black-50">사용자 이름</span> 
						<span class="text-black-50">사용자 온도(글자로만 보여줄거면 이렇게)</span>
						<div class="bar" style="--percent: 50;"></div>
						<span class="text-black-50">사용자 선호 식품</span>
				</div>
			...
			<div class="col-md-5 border-right">
				<div class="p-3 py-5">
					...
					<div class="mt-5 text-center">
						<button class="btn btn-primary profile-button">버튼 대신 이미지로 대체
							</button>
					</div>
				</div>
			</div>
